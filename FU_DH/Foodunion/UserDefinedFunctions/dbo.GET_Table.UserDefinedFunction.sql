USE [Foodunion]
GO
DROP FUNCTION [dbo].[GET_Table]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create FUNCTION [dbo].[GET_Table] (
...
WITH    db1(dbname)
    ...
    WITH    ColumnDefs
            ...
            IndexDefs
                AS (SELECT    TableObj = i.[object_id], IxName = QUOTENAME(i.name+CASE WHEN @new=1 THEN '_'+'233' ELSE '' end), IxPKFlag = i.is_primary_key,
