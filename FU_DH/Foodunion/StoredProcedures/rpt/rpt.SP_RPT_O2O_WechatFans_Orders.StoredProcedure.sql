USE [Foodunion]
GO
/****** Object:  StoredProcedure [rpt].[SP_RPT_O2O_WechatFans_Orders]    Script Date: 2019/7/31 9:59:32 ******/
DROP PROCEDURE [rpt].[SP_RPT_O2O_WechatFans_Orders]
GO
/****** Object:  StoredProcedure [rpt].[SP_RPT_O2O_WechatFans_Orders]    Script Date: 2019/7/31 9:59:32 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [rpt].[SP_RPT_O2O_WechatFans_Orders]
AS
BEGIN 
