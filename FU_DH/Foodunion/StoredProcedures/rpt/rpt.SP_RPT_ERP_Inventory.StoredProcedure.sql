USE [Foodunion]
GO
DROP PROCEDURE [rpt].[SP_RPT_ERP_Inventory]
GO
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROC  [rpt].[SP_RPT_ERP_Inventory]
...
FROM(
	...
	NULL AS Is_Damaged,
	NULL AS Is_Expired,
	(CASE WHEN DATEDIFF(DAY,T.Storaging_Date,CAST(Datekey AS VARCHAR))<5 THEN '<5 Days' 
