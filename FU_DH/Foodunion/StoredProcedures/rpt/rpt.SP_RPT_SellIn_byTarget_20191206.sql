...
GO
  ...
  CREATE PROC  [rpt].[SP_RPT_SellIn_byTarget_20191206]
  as
  BEGIN
	...
	*/
	...
	SELECT DISTINCT CASE WHEN ISNULL(ch.[Team],sit.Team) IN ('OFFLINE','Dragon Team','YH') THEN 1 WHEN ch.Team IN ('Phoenix Team') THEN 2 ELSE 99 END  AS CID
