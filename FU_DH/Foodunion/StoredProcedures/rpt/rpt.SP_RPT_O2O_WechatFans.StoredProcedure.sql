USE [Foodunion]
GO
/****** Object:  StoredProcedure [rpt].[SP_RPT_O2O_WechatFans]    Script Date: 2019/7/31 9:59:32 ******/
DROP PROCEDURE [rpt].[SP_RPT_O2O_WechatFans]
GO
/****** Object:  StoredProcedure [rpt].[SP_RPT_O2O_WechatFans]    Script Date: 2019/7/31 9:59:32 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [rpt].[SP_RPT_O2O_WechatFans]
AS
BEGIN 
