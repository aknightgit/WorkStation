...
CREATE PROCEDURE [rpt].[SP_RPT_Sales_YH_MonthlyPerformance_Overview_20191203]
AS BEGIN 
...
SELECT  
	 CASE WHEN ds.Account_Area_CN NOT IN ('重庆大区','四川大区','北京大区','福建大区','华东大区','安徽大区','陕西大区','东北大区') THEN '其他' ELSE LEFT(ds.Account_Area_CN,2) END AS Account_Area_CN
	...
	,(SELECT SUM(cds2.Sales_AMT) 
		...
		WHERE ds2.Channel_Account='YH' 
		AND CASE WHEN ds.Account_Area_CN NOT IN ('重庆大区','四川大区','北京大区','福建大区','华东大区','安徽大区','陕西大区','东北大区') THEN '其他' ELSE LEFT(ds.Account_Area_CN,2) END
			=CASE WHEN ds2.Account_Area_CN NOT IN ('重庆大区','四川大区','北京大区','福建大区','华东大区','安徽大区','陕西大区','东北大区') THEN '其他' ELSE LEFT(ds2.Account_Area_CN,2) END
...
GROUP BY  CASE WHEN ds.Account_Area_CN NOT IN ('重庆大区','四川大区','北京大区','福建大区','华东大区','安徽大区','陕西大区','东北大区') THEN '其他' ELSE LEFT(ds.Account_Area_CN,2) END
	     ,LEFT(kds.Datekey,6)
		 order by MonthKey
