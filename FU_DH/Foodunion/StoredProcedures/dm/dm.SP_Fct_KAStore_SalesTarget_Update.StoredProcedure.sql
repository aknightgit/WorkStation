USE [Foodunion]
GO
DROP PROCEDURE [dm].[SP_Fct_KAStore_SalesTarget_Update]
GO
SET ANSI_NULLS ON
GO
...
BEGIN
   ...
   --VG
	INSERT INTO [dm].[Fct_KAStore_SalesTarget_Monthly]
           ...
           ,[Update_Time]
           ,[Update_By])
	SELECT 201908,'VG','','','',0,0,700000,GETDATE(),'Mannual',GETDATE(),'Mannual'
	UNION 
	SELECT 201909,'VG','','','',0,0,600000,GETDATE(),'Mannual',GETDATE(),'Mannual'
	UNION 
	SELECT 201910,'VG','','','',0,0,855000,GETDATE(),'Mannual',GETDATE(),'Mannual';
	...
	SELECT a.Year
		   ...
		   ,@ProcName AS [Update_By]
	FROM 
	(SELECT 201908 AS Monthkey,	700000 AS [Sales_Target])t
