...
GO
CREATE PROCEDURE  [dm].[SP_Fct_Sales_SellOut_byChannel_byRegion_Update_20200109] --400
	@Ret_Days INT = 90
AS
BEGIN
   ...
   GROUP BY CONVERT(VARCHAR(10),[Order_Creation_Time],112)
	...
	JOIN dm.Dim_Channel dc WITH(NOLOCK) ON si.Channel_ID = dc.Channel_ID AND dc.Channel_Type = 'CP' 
