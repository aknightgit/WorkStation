USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_MiscStockEntry] DROP CONSTRAINT [DF__Fct_ERP_S__Updat__5DC0CDC3]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_MiscStockEntry] DROP CONSTRAINT [DF__Fct_ERP_S__Creat__5CCCA98A]
GO
DROP TABLE [dm].[Fct_ERP_Stock_MiscStockEntry]
GO
SET ANSI_NULLS ON
GO
