...
GO
CREATE TABLE [dm].[Fct_Sales_SellIn_ByChannel_BySKU](
 ...
 CONSTRAINT [PK_Fct_Sales_SellIn_ByChannel_BySKU_ADC9] PRIMARY KEY CLUSTERED 
(
	[Monthkey] ASC,
	[Datekey] ASC,
	[Customer_ID] ASC,
...
GO
ALTER TABLE [dm].[Fct_Sales_SellIn_ByChannel_BySKU] ADD  CONSTRAINT [DF_Fct_Sales_SellIn_ByChannel_BySKU_Create_time]  DEFAULT (getdate()) FOR [Create_time]
GO
ALTER TABLE [dm].[Fct_Sales_SellIn_ByChannel_BySKU] ADD  CONSTRAINT [DF_Fct_Sales_SellIn_ByChannel_BySKU_Update_time]  DEFAULT (getdate()) FOR [Update_time]
GO
