USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_O2O_Order_Delivery_Detail] DROP CONSTRAINT [DF__Fct_O2O_O__Updat__34A9A997]
GO
ALTER TABLE [dm].[Fct_O2O_Order_Delivery_Detail] DROP CONSTRAINT [DF__Fct_O2O_O__Creat__33B5855E]
GO
DROP TABLE [dm].[Fct_O2O_Order_Delivery_Detail]
GO
SET ANSI_NULLS ON
GO
