USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_Order] DROP CONSTRAINT [DF__Fct_Order__Updat__40DA7652]
GO
ALTER TABLE [dm].[Fct_Order] DROP CONSTRAINT [DF__Fct_Order__Creat__3FE65219]
GO
DROP TABLE [dm].[Fct_Order]
GO
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dm].[Fct_Order](
 ...
 CONSTRAINT [PK_Fct_Order2] PRIMARY KEY CLUSTERED 
(
	[Order_Key] ASC,
	[Order_DateKey] ASC,
	[Order_ID] ASC
...
GO
ALTER TABLE [dm].[Fct_Order] ADD  DEFAULT (getdate()) FOR [Create_Time]
GO
ALTER TABLE [dm].[Fct_Order] ADD  DEFAULT (getdate()) FOR [Update_Time]
GO
