USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_Order_Payment] DROP CONSTRAINT [df_Fct_Order_Payment_Update_Time]
GO
ALTER TABLE [dm].[Fct_Order_Payment] DROP CONSTRAINT [df_Fct_Order_Payment_Create_Time]
GO
ALTER TABLE [dm].[Fct_Order_Payment] DROP CONSTRAINT [df_Fct_Order_Payment_SeqID]
GO
DROP TABLE [dm].[Fct_Order_Payment]
GO
SET ANSI_NULLS ON
GO
