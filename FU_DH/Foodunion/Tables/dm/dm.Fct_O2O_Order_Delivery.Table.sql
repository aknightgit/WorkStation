USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_O2O_Order_Delivery] DROP CONSTRAINT [DF__Fct_O2O_O__Updat__3D3EEF98]
GO
ALTER TABLE [dm].[Fct_O2O_Order_Delivery] DROP CONSTRAINT [DF__Fct_O2O_O__Creat__3C4ACB5F]
GO
DROP TABLE [dm].[Fct_O2O_Order_Delivery]
GO
SET ANSI_NULLS ON
GO
