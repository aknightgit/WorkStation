USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_O2O_Order_Base_info_20190806] DROP CONSTRAINT [DF__Fct_O2O_O__Updat__03275C9C]
GO
ALTER TABLE [dm].[Fct_O2O_Order_Base_info_20190806] DROP CONSTRAINT [DF__Fct_O2O_O__Creat__02333863]
GO
DROP TABLE [dm].[Fct_O2O_Order_Base_info_20190806]
GO
SET ANSI_NULLS ON
GO
