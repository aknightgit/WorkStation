USE [Foodunion]
GO
ALTER TABLE [dm].[Dim_Order] DROP CONSTRAINT [DF__Dim_Order__Updat__5ECA0095]
GO
ALTER TABLE [dm].[Dim_Order] DROP CONSTRAINT [DF__Dim_Order__Creat__5DD5DC5C]
GO
DROP TABLE [dm].[Dim_Order]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dm].[Dim_Order](
...
GO
ALTER TABLE [dm].[Dim_Order] ADD  DEFAULT (getdate()) FOR [Create_Time]
GO
ALTER TABLE [dm].[Dim_Order] ADD  DEFAULT (getdate()) FOR [Update_Time]
GO
