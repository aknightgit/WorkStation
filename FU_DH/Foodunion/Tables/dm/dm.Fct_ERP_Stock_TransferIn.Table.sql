USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_TransferIn] DROP CONSTRAINT [DF__Fct_ERP_S__Updat__40657506]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_TransferIn] DROP CONSTRAINT [DF__Fct_ERP_S__Creat__3F7150CD]
GO
DROP TABLE [dm].[Fct_ERP_Stock_TransferIn]
GO
SET ANSI_NULLS ON
GO
