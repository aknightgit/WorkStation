USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_InStock] DROP CONSTRAINT [DF__Fct_ERP_S__Updat__5F1F0650]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_InStock] DROP CONSTRAINT [DF__Fct_ERP_S__Creat__5E2AE217]
GO
DROP TABLE [dm].[Fct_ERP_Stock_InStock]
GO
SET ANSI_NULLS ON
GO
