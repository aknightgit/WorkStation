USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_TransferOutEntry] DROP CONSTRAINT [DF__Fct_ERP_S__Updat__38C4533E]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_TransferOutEntry] DROP CONSTRAINT [DF__Fct_ERP_S__Creat__37D02F05]
GO
DROP TABLE [dm].[Fct_ERP_Stock_TransferOutEntry]
GO
SET ANSI_NULLS ON
GO
