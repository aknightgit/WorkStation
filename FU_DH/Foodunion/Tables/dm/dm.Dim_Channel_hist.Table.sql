USE [Foodunion]
GO
ALTER TABLE [dm].[Dim_Channel_hist] DROP CONSTRAINT [DF__Dim_Chann__Updat__05B9B084]
GO
ALTER TABLE [dm].[Dim_Channel_hist] DROP CONSTRAINT [DF__Dim_Chann__Creat__04C58C4B]
GO
DROP TABLE [dm].[Dim_Channel_hist]
GO
SET ANSI_NULLS ON
GO
