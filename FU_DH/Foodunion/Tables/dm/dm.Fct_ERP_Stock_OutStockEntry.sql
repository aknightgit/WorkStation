...
CREATE TABLE [dm].[Fct_ERP_Stock_OutStockEntry](
	...
	[Goods_Value] [decimal](18, 5) NULL,
	[Full_Goods_Value] [decimal](18, 5) NULL,
	[IsFree] [bit] NULL,
	[IsSKU] [int] NULL,
 ...
 CONSTRAINT [PK__Fct_ERP___BAC9BC404F1F7B7E_699B_AE29] PRIMARY KEY CLUSTERED 
(
	[OutStock_ID] ASC,
	[Sequence_ID] ASC,
	[SKU_ID] ASC
...
GO
ALTER TABLE [dm].[Fct_ERP_Stock_OutStockEntry] ADD  CONSTRAINT [DF__Fct_ERP_S__Creat__6E6149E0]  DEFAULT (getdate()) FOR [Create_Time]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_OutStockEntry] ADD  CONSTRAINT [DF__Fct_ERP_S__Updat__6F556E19]  DEFAULT (getdate()) FOR [Update_Time]
GO
