...
CREATE TABLE [dm].[Fct_ERP_Sale_OrderEntry](
 ...
 CONSTRAINT [PK__Fct_ERP___A13E8663851D6DE1_6EB3] PRIMARY KEY CLUSTERED 
(
	[Order_Entry_ID] ASC,
	[Sale_Order_ID] ASC
...
GO
ALTER TABLE [dm].[Fct_ERP_Sale_OrderEntry] ADD  CONSTRAINT [DF__Fct_ERP_S__Creat__4396E76C]  DEFAULT (getdate()) FOR [Create_Time]
GO
ALTER TABLE [dm].[Fct_ERP_Sale_OrderEntry] ADD  CONSTRAINT [DF__Fct_ERP_S__Updat__448B0BA5]  DEFAULT (getdate()) FOR [Update_Time]
GO
