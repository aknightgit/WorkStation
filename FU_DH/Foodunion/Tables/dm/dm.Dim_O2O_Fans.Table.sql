USE [Foodunion]
GO
ALTER TABLE [dm].[Dim_O2O_Fans] DROP CONSTRAINT [DF__Dim_O2O_F__Updat__0564AAC9]
GO
ALTER TABLE [dm].[Dim_O2O_Fans] DROP CONSTRAINT [DF__Dim_O2O_F__Creat__04708690]
GO
DROP TABLE [dm].[Dim_O2O_Fans]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dm].[Dim_O2O_Fans](
	...
	[KOL_EmployeeName] [varchar](64) NULL,
...
GO
ALTER TABLE [dm].[Dim_O2O_Fans] ADD  DEFAULT (getdate()) FOR [Create_Time]
GO
ALTER TABLE [dm].[Dim_O2O_Fans] ADD  DEFAULT (getdate()) FOR [Update_Time]
GO
