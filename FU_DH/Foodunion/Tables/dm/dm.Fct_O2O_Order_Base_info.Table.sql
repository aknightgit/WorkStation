USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_O2O_Order_Base_info] DROP CONSTRAINT [DF__Fct_O2O_O__Updat__70698DE3]
GO
ALTER TABLE [dm].[Fct_O2O_Order_Base_info] DROP CONSTRAINT [DF__Fct_O2O_O__Creat__6F7569AA]
GO
DROP TABLE [dm].[Fct_O2O_Order_Base_info]
GO
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dm].[Fct_O2O_Order_Base_info](
 ...
 CONSTRAINT [PK__Fct_O2O___B78419304789D06D_A848_BE6E_F8E6_F722] PRIMARY KEY CLUSTERED 
(
	[Datekey] ASC,
	[Order_ID] ASC
