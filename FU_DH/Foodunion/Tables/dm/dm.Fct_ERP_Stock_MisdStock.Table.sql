USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_MisdStock] DROP CONSTRAINT [DF__Fct_ERP_S__Updat__61915EA7]
GO
ALTER TABLE [dm].[Fct_ERP_Stock_MisdStock] DROP CONSTRAINT [DF__Fct_ERP_S__Creat__609D3A6E]
GO
DROP TABLE [dm].[Fct_ERP_Stock_MisdStock]
GO
SET ANSI_NULLS ON
GO
