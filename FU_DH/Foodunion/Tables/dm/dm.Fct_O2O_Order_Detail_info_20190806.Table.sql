USE [Foodunion]
GO
ALTER TABLE [dm].[Fct_O2O_Order_Detail_info_20190806] DROP CONSTRAINT [DF__Fct_O2O_O__Updat__7D6E8346]
GO
ALTER TABLE [dm].[Fct_O2O_Order_Detail_info_20190806] DROP CONSTRAINT [DF__Fct_O2O_O__Creat__7C7A5F0D]
GO
DROP TABLE [dm].[Fct_O2O_Order_Detail_info_20190806]
GO
SET ANSI_NULLS ON
GO
