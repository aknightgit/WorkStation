...
GO
CREATE TABLE [dm].[Fct_Order_Hist](
 ...
 CONSTRAINT [PK_Fct_Order_Hist] PRIMARY KEY CLUSTERED 
(
	[Order_Key] ASC,
	[Order_DateKey] ASC,
	[Order_ID] ASC
...
GO
ALTER TABLE [dm].[Fct_Order_Hist] ADD  CONSTRAINT [DF__Fct_Order__Creat__Hist]  DEFAULT (getdate()) FOR [Create_Time]
GO
ALTER TABLE [dm].[Fct_Order_Hist] ADD  CONSTRAINT [DF__Fct_Order__Updat__Hist]  DEFAULT (getdate()) FOR [Update_Time]
GO
