USE [Foodunion]
GO
ALTER TABLE [rpt].[O2O_Employee_Commission] DROP CONSTRAINT [DF__O2O_Emplo__Updat__1C1305F7]
GO
ALTER TABLE [rpt].[O2O_Employee_Commission] DROP CONSTRAINT [DF__O2O_Emplo__Creat__1B1EE1BE]
GO
DROP TABLE [rpt].[O2O_Employee_Commission]
GO
SET ANSI_NULLS ON
GO
