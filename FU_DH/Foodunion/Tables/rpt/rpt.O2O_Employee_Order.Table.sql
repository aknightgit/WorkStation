USE [Foodunion]
GO
ALTER TABLE [rpt].[O2O_Employee_Order] DROP CONSTRAINT [DF__O2O_Emplo__Updat__18777F3D]
GO
ALTER TABLE [rpt].[O2O_Employee_Order] DROP CONSTRAINT [DF__O2O_Emplo__Creat__17835B04]
GO
DROP TABLE [rpt].[O2O_Employee_Order]
GO
SET ANSI_NULLS ON
GO
