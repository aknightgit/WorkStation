USE [ConfigDB]
GO
ALTER TABLE [cfg].[Connections] DROP CONSTRAINT [DF__Connectio__Updat__1BA8F1A3]
GO
ALTER TABLE [cfg].[Connections] DROP CONSTRAINT [DF__Connectio__Inser__1AB4CD6A]
GO
ALTER TABLE [cfg].[Connections] DROP CONSTRAINT [DF__Connectio__Serve__19C0A931]
GO
DROP TABLE [cfg].[Connections]
GO
SET ANSI_NULLS ON
GO
