...
GO
ALTER TABLE [cfg].[AuditConfig] ADD  CONSTRAINT [DF__AuditConf__MaxAl__09003183]  DEFAULT ((0)) FOR [MaxAllowed]
GO
ALTER TABLE [cfg].[AuditConfig] ADD  CONSTRAINT [DF__AuditConf__IsEna__09F455BC]  DEFAULT ((1)) FOR [IsEnabled]
GO
ALTER TABLE [cfg].[AuditConfig] ADD  CONSTRAINT [DF__AuditConf__Inser__0AE879F5]  DEFAULT (getdate()) FOR [InsertDatetime]
GO
ALTER TABLE [cfg].[AuditConfig] ADD  CONSTRAINT [DF__AuditConf__Updat__0BDC9E2E]  DEFAULT (getdate()) FOR [UpdateDatetime]
GO
