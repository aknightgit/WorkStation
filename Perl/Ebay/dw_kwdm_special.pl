...
my $Stubhub_mls="$DATDIR/Stubhub.mls";
my $Scrub_mls="$DATDIR/Scrub.mls";
my $Stubhub_tls="$DATDIR/Stubhub.tls";
my $Scrub_tls="$DATDIR/Scrub.tls";
...
my $COST_DATA_FEED_tls="$DATDIR/COST_DATA_FEED.tls";
my $COST_DATA_FEED_mls="$DATDIR/COST_DATA_FEED.mls";
...
my $MPXLT_mls="$DATDIR/MPXLT.mls";
my $MPXLT_tls="$DATDIR/MPXLT.tls";
